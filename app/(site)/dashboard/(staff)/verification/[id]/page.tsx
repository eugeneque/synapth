...
export default async function VerificationRequestPage({ params }: Props) {
  ...
  if (!session?.user) redirect(`/signin?callbackUrl=/dashboard/verification/${id}`);
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/dashboard/verification" className="label-mono-sm inline-flex items-center gap-1.5 transition-colors hover:text-synapse">
